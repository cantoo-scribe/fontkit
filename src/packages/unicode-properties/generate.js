...
fs.writeFileSync(new URL('./data.trie', import.meta.url), buf);
fs.writeFileSync(new URL('./data.json', import.meta.url), JSON.stringify(json));
fs.writeFileSync(new URL('./data.js', import.meta.url), `export default ${JSON.stringify(json)};\n`);
fs.writeFileSync(new URL('./data-trie.js', import.meta.url), `export default ${JSON.stringify(buf.toString('base64'))};\n`);
